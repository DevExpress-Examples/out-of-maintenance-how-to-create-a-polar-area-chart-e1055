...
Namespace Series_PolarAreaChart
    Partial Public Class Form1
        ...
        Private Sub Form1_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
            ...
            CType(polarAreaChart.Diagram, PolarDiagram).RotationDirection = RadarDiagramRotationDirection.Counterclockwise

            ' Add a title to the chart and hide the legend.
            Dim chartTitle1 As New ChartTitle()
            chartTitle1.Text = "Polar Area Chart"
            polarAreaChart.Titles.Add(chartTitle1)
            polarAreaChart.Legend.Visibility = DevExpress.Utils.DefaultBoolean.False
